...
1. Quote the source AT MOST ONCE, fewer than 15 words, in quotation marks.
1. Link to the source publication in your prose using a Markdown link on the publication name (e.g., “[9to5Mac](https://...) reported…”). Use the exact URL provided.
1. Do not reproduce the source’s structure or sentence patterns. Don’t summarize - react.
