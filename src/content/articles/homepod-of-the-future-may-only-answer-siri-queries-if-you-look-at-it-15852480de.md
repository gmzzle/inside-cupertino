...
source:
  name: "AppleInsider"
  url: "https://appleinsider.com/articles/20/12/08/future-homepods-may-only-answer-siri-queries-if-you-look-at-it?utm_source=rss"
---

[AppleInsider](https://appleinsider.com/articles/20/12/08/future-homepods-may-only-answer-siri-queries-if-you-look-at-it?utm_source=rss) spotted a patent filing where Apple's exploring gaze detection for HomePod. The idea: cameras on the device track where you're looking, so when you say "Siri" (or maybe nothing at all), only the HomePod you're actually facing responds. It's a direct answer to the chaos of having multiple Apple devices all fighting to handle your voice command.
